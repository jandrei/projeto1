 ...
 *Realizando um teste de importaÁ„o do projeto
 *este È um teste
 *este È um testeeste È um teste
 *este È um teste
 *este È um teste
 *
 *
...
public class LoginForm extends JDialog implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if ("Entrar".equals(e.getActionCommand())) {
            ...
            JOptionPane.showMessageDialog(this, "Usu√°rio e senha inv√°lidos", "Erro", JOptionPane.ERROR_MESSAGE);
        } else {
            System.exit(0);
        }
    }
